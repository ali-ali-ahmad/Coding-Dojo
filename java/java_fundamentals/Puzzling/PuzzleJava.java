...
public class PuzzleJava {
    ...
    public ArrayList<Integer> getTenRolls() {
        ...
        ArrayList<Integer> randomOfTen = new ArrayList<Integer>();
        Random rand = new Random();

        for (int i = 1; i <=10; i++) {
            randomOfTen.add(rand.nextInt(20) + 1);
        }
    ...
    // generatePassword
    // Write a method that uses the previous method to create a random string of eight 
    ...
    // getNewPasswordSet
    // Write a method that takes an int length as an argument and creates an array of 
    // random eight character words. The array should be the length passed in as an int.
    ...
    // pseudo-random way. Hint: use random indexes within the array, and swap values repeatedly.
