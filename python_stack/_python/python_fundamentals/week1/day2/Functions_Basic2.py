...
list = [30, 4, 5, 13, 12, 34]
def firstPlusLength(sum):
    a = list[0]
    b = len(list)
    sum = (a+b)
    return sum
print(firstPlusLength(sum))
# ----------------------------------------
# 4) Values Greater than Second - Write a function that accepts a list and 
# creates a new list containing only the values from the original list that are greater 
# than its 2nd value. Print how many values this is and then return the new list. If the 
# list has less than 2 elements, have the function return False
# Example: values_greater_than_second([5,2,3,2,1,4]) should print 3 and return [5,3,4]
# Example: values_greater_than_second([3]) should return False

list = [5, 2, 3, 2, 1, 4]
newList = []
def greaterThan(newList):
